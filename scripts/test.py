...
from transformers import BitsAndBytesConfig, AutoModelForCausalLM, AutoTokenizer, GemmaTokenizer
    ...
    while True:
        try:
            ...
            if chat_input.lower() == "exit":
                break
            response = chain.run({"role": "user", "content": chat_input})
